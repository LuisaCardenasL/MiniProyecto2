...
public class GUI extends JFrame{
    ...
    private int caraCarta, numeroCartas, numeroParejas, numeroJugadas, cartaRevelada, pareja, bandera, juego, aciertos, fallas, oportunidades;
    ...
    private void initComponents(){
        ...
        lOportunidades = new JLabel("Oportunidades: " + oportunidades);
        ...
        manejadoraEventos escucha = new manejadoraEventos();
        ...
        public void mouseClicked(MouseEvent e) {
            if(e.getSource() == bInicio){
                ...
                if (e.getSource() == bPareja[i] && cartaRevelada != 1) {
                    numeroJugadas++;//si se presiona 2 veces seguidas un botón, se incrementa la posicion del arreglo
                    //bPareja[i] = 1;   //Voltear las cartas
                        if (numeroJugadas == 2){
                            ...
                            if (bPareja[i] == bPareja[i]){
                                aciertos++;
                                if(aciertos == numeroParejas){
                                    System.out.println("ÑAM! Ganaste!");
                                    //Insertar botón de reinicio para LimpiarGUI
                                }
                            }
                            else
                            {
                                ...
                                oportunidades--;
                                    if(oportunidades == 0){
                                        System.out.println("Aw, has perdido...");
                                        //Insertar botón de reinicio para LimpiarGUI
                                    }
                            }
                        }
